...
<body>
	...
	For Ex in the expression &#36;{test=StaticFieldsAndMethodsForELTest(); test["accessPropertiesFromEL"]}, new object is created and the property is accessed in that object: ${test=StaticFieldsAndMethodsForELTest(); test["accessPropertiesFromEL"]}
	<br/>
